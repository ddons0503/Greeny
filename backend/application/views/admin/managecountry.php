                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="element-wrapper">
                                        <h6 class="element-header">Country</h6>
                                        <div class="row">
                                            <?php
                                                        ...
                                                        <div class="element-box">
                                                            <form action="" method="post">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="country" class="form-control <?php
                                                                    if (form_error('name')) {
                                                                        echo 'invalid';
                                                                    }
                                                                    ?>" placeholder="Enter Country Name" value="<?php
                                                                           if (!isset($success) && set_value('country')) {
                                                                               echo set_value('country');
                                                                           } else {
                                                                               echo $editcountry->name;
                                                                           }
                                                                           ?>" >
                                                                    <p class="errmsg">
                                                                        <?php
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <a  href="<?php echo base_url('manage-country') ?>" class="btn m-b-5 mt-1 mb-0">cancel</a>
                                                                </div>
                                                                <div>
                                                                    <?php
                                                                    if (isset($error)) {
                                            ...
                                            <div class="col-lg-6">
                                                <div class="element-wrapper">
                                                    <div class="element-box">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-8">
                                                                <h5 class="form-header">View All Countries</h5>   
                                                            </div>

                                                            <div class="col-4">
                                                                <button class="btn btn-danger" onclick="delete_record('country', '<?php echo base64_encode(base64_encode(0)); ?>')" data-toggle="modal" data-target="#staticBackdrop">Delete All Records</button>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($country as $data) {
                                                                        ...
                                                                        <tr align="center">
                                                                            ...
                                                                            <td style="vertical-align: middle"><a href="<?php base_url() ?>edit-country/<?php echo base64_encode(base64_encode($data->location_id)) ?>"><i class="fa fa-pencil" style="color: blue" data-toggle="tooltip"  data-placement="bottom" title="Edit" data-toggle="modal" data-target="#exampleModal" ></i></a></td>
                                                                            <td style="vertical-align: middle">
                                                                                <a href="" onclick="delete_record('country', '<?php echo base64_encode(base64_encode($data->location_id)); ?>')" data-toggle="modal" data-target="#staticBackdrop">
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-danger" data-dismiss="modal">No Cancel It?</button>
